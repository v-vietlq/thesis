...
from utils.utils import create_dataloader, validate
...
if __name__ == '__main__':
    main()
#     args = parser.parse_args()
#     from models.backbone.resnet import resnet34
#     from models.clsnetwork import EventNetwork
#     import torch.nn as nn
#     # Setup model
#     print('creating and loading the model...')
#     # model = create_model(args).cuda()
#     m = EventNetwork(encoder_name='resnet34', num_classes=23).cuda()
#     x = torch.randn(56, 3, 224, 224).cuda()
#     o = m(x)
#     print(o.shape)
